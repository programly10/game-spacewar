...
# pemanggilan image
''' IMAGES '''
player_ship = 'image/plyrship.png'
enemy_ship = 'image/enemyship.png'
ufo_ship = 'image/ufoship.png'
player_bullet = 'image/plybullet.png'
enemy_bullet = 'image/enbullet.png'
ufo_bullet = 'image/enbullet.png'

''' SOUND '''
suara_laser = pygame.mixer.Sound('suara/laser.wav')
suara_ledakan = pygame.mixer.Sound('suara/ledakan.wav')
suara_ayo = pygame.mixer.Sound('suara/ayo.wav')
suara_game_over = pygame.mixer.Sound('suara/game_over.wav')
musik_start = pygame.mixer.Sound('suara/cyberfunk.mp3')
musik_game_over = pygame.mixer.Sound('suara/illusoryrealm.mp3')

background_musik = pygame.mixer.music.load('suara/epicsong.mp3')
...
class Player(pygame.sprite.Sprite):
    ...
    def dead(self):
        ...
        pygame.mixer.Sound.play(suara_ledakan)
...
class Enemy(Player):
    ...
    def shoot(self):
        if self.rect.y in (0,30,50,300,700):
...
class Game:
    ...
    # metode untuk membuat start game
    def start_screen(self):
        pygame.mixer.Sound.stop(musik_game_over)
        pygame.mixer.Sound.play(musik_start)
        self.lives = 3
        sprite_group.empty()
        while True:
            screen.fill('black')
    ...
    # method untuk membuat pause game
    ...
    # method untuk membuat game over 
    def game_over_screen(self):
        pygame.mixer.music.stop()
        pygame.mixer.Sound.play(suara_game_over)
        while True:
            screen.fill('black')
            self.game_over_text()
            self.game_over_sound_delay += 1
            if self.game_over_sound_delay > 1400:
                pygame.mixer.Sound.play(musik_game_over)
    ...
    # method player untuk menembak ufo
    ...
    # method tampilan Healt Point player
    ...
    # membuat score pada layar
    def create_score(self):
        score = self.score
        font = pygame.font.SysFont('Calibri', 20)
        text = font.render("KILL: "+str(score), True,'green')
        text_rect = text.get_rect(center=(s_width-60, s_height-760))
        screen.blit(text, text_rect)

    # method untuk update bg screen
    def run_update(self):
        sprite_group.draw(screen)
        sprite_group.update()

    # method menjalankan game
    def run_game(self):
        pygame.mixer.Sound.stop(musik_start)
        pygame.mixer.Sound.play(suara_ayo)
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == KEYDOWN:
                    pygame.mixer.Sound.play(suara_laser)
                    self.player.shoot()
                    if event.key == K_ESCAPE:
                        pygame.quit()
                        sys.exit()
